...
const ButtonBar = (props) => (
  <div className="btn-bar">
    <ViewButton type="console"
                viewIndex={0}
                look={(props.currentView === 0 || props.viewTransitioningIn === 0)  ? "view-btn console-btn active-btn" : "view-btn console-btn"}
                svgdir="../media/tabicon1.svg" />
    <ViewButton type="inventory"
                viewIndex={1}
                look={(props.currentView === 1 || props.viewTransitioningIn === 1) ? "view-btn inventory-btn active-btn" : "view-btn inventory-btn"}
